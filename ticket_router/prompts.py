...
PRIORITY_RULES = """
- High: payment charged but order failed, wrong item received on an urgent order, account locked and preventing a purchase
- Medium: delivery delay, return not yet processed, tracking not updated
